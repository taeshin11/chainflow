...
export default function ShareButtons({ title, url }: ShareButtonsProps) {
  ...
  const btnClass =
    'inline-flex items-center justify-center w-8 h-8 rounded-lg border border-cf-border bg-white text-cf-text-secondary hover:text-cf-primary hover:border-cf-primary transition-colors';
