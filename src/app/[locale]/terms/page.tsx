      ...
      <div className="cf-card p-8 space-y-8">
        ...
        <section>
          <p className="text-cf-text-secondary leading-relaxed">
            ...
            operated by SPINAI (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;). By accessing or using the Site and Service,
        ...
        <section>
          ...
          <div className="space-y-4 text-cf-text-secondary leading-relaxed">
            <p>
              ...
              binding agreement between you and SPINAI. If you are using the Service on behalf of an
        ...
        <section>
          ...
          <div className="space-y-4 text-cf-text-secondary leading-relaxed">
            <p>
              ...
              thereof, are the exclusive property of SPINAI and are protected by United States and
            ...
            <p>
              ...
              designs, and slogans are trademarks of SPINAI. You may not use such marks without our
        ...
        <section>
          ...
          <div className="space-y-4 text-cf-text-secondary leading-relaxed">
            <p>
              TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL SPINAI, ITS
        ...
        <section>
          ...
          <p className="text-cf-text-secondary leading-relaxed">
            You agree to indemnify, defend, and hold harmless SPINAI, its directors, officers,
        ...
        <section>
          ...
          <div className="space-y-4 text-cf-text-secondary leading-relaxed">
            <p>
              ...
              BY APPLICABLE LAW, SPINAI DISCLAIMS ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING BUT
        ...
        <section>
          ...
          <p className="text-cf-text-secondary leading-relaxed">
            ...
            to SPINAI, including without limitation any indemnification obligations.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-cf-text-secondary leading-relaxed">
            ...
            you and SPINAI with respect to the Site and Service and supersede all prior or
            contemporaneous communications, proposals, and agreements, whether oral or written,
            between you and SPINAI regarding the Site and Service. No waiver of any provision of
        ...
        <section>
          ...
          <div className="text-cf-text-secondary leading-relaxed">
            ...
            <div className="bg-cf-background rounded-lg p-4">
              <p className="font-medium text-cf-text-primary">SPINAI — ChainFlow</p>
